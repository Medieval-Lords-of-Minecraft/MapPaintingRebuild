...
import net.aegistudio.mpp.palette.PaletteCmd;
...
public class MapPainting extends JavaPlugin {
	...
	// declare "global" variables (but not define)
	// not really global because they are members of mappainting javaplugin
    ...
    public PaletteManager m_paletteManager;
    ...
    // wtf - why are we declaring strings here, let alone final strings, these should be localised
    ...
    public void onEnable() {
        ...
        try {
            ...
            this.m_commandHandler.add("buy", new PigmentCommand());
            ...
            this.m_paletteManager.load(this, config.getConfigurationSection(PALETTE));
    ...
    public void onDisable() {
        try {
            ...
            m_paletteManager.save(this, config.getConfigurationSection(PALETTE));
