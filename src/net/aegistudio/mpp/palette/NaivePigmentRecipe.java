...
public class NaivePigmentRecipe
implements Module {
    public MapPainting painting;

    public Color getColor(ItemStack dye) {
        java.awt.Color awtColor = painting.m_paletteManager.getColor(dye);
    ...
    public void setColor(ItemStack dye, Color newColor) {
        PaletteManager.setColor(dye, newColor);
    ...
    public void load(MapPainting painting, ConfigurationSection section) throws Exception {
        ...
        painting.getServer().getPluginManager().registerEvents((Listener)new NaivePigmentListener(painting.m_paletteManager), (Plugin)painting);
    }
