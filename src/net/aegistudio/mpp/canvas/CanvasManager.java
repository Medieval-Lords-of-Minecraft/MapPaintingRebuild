...
import net.aegistudio.mpp.canvas.CachedCanvasColor;
import net.aegistudio.mpp.canvas.CanvasColor;
import net.aegistudio.mpp.canvas.CanvasPaintListener;
import net.aegistudio.mpp.canvas.CanvasScopeListener;
import net.aegistudio.mpp.canvas.CanvasSwitchListener;
